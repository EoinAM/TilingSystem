...
{
	m_textureDict["floor_1"] = sf::Texture(t_floor1);
	m_textureDict["floor_2"] = sf::Texture(t_floor2);
	m_textureDict["wall_1"] = sf::Texture(t_wall1);
	m_textureDict["wall_2"] = sf::Texture(t_wall2);
	m_textureDict["door_open"] = sf::Texture(t_doorOpen);
	m_textureDict["door_close"] = sf::Texture(t_doorClosed);
